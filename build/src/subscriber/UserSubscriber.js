...
var UserSubscriber = /** @class */ (function () {
    ...
    UserSubscriber.prototype.afterInsert = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var preference, profile, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        preference = new UserPreference_1.UserPreference();
                        preference.user = event.entity;
                        return [4 /*yield*/, event.manager.getRepository(UserPreference_1.UserPreference).save(preference)
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, event.manager.getRepository(Profile_1.Profile).save(profile)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
