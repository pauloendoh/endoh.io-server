...
const Expense_1 = require("../../entities/monerate/Expense");
let ExpenseRepository = class ExpenseRepository extends typeorm_1.Repository {
    getAllExpensesFromUser(user) {
    ...
    saveAndGetEntireModel(expense) {
        return __awaiter(this, void 0, void 0, function* () {
            const savedExpense = yield this.save(expense);
