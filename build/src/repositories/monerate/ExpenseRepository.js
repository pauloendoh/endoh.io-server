...
var Expense_1 = require("../../entities/monerate/Expense");
var ExpenseRepository = /** @class */ (function (_super) {
    __extends(ExpenseRepository, _super);
    function ExpenseRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ExpenseRepository.prototype.getAllExpensesFromUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createQueryBuilder("decision")
                        .where({ user: user })
    ...
    ExpenseRepository.prototype.saveAndGetEntireModel = function (expense) {
        return __awaiter(this, void 0, void 0, function () {
            var savedExpense;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.save(expense)];
                    case 1:
