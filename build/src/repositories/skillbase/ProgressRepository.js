...
var ProgressRepository = /** @class */ (function (_super) {
    __extends(ProgressRepository, _super);
    function ProgressRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ProgressRepository.prototype.getAllFromUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createQueryBuilder("progress")
                        .where({ userId: userId })
