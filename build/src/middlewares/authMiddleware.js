...
function authMiddleware(req, res, next) {
    ...
    // Verify token
    try {
        jsonwebtoken_1.verify(authToken, process.env[DotEnvKeys_1.DotEnvKeys.JWT_SECRET], function (error, decodedObj) { return __awaiter(_this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!error) return [3 /*break*/, 1];
                        return [2 /*return*/, res.status(401).json({ msg: 'Token is not valid. Sign in and try again.' })];
                    case 1:
                        _a = req;
