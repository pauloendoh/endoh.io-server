...
typeorm_1.createConnection(ormconfig).then((connection) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fs.readdirSync(`${__dirname}/routes`).forEach((fileOrFolderName) => __awaiter(void 0, void 0, void 0, function* () {
        if (fileOrFolderName.endsWith('.ts') || fileOrFolderName.endsWith('.js')) {
            const routeName = fileOrFolderName.split('Route')[0];
            const module = yield Promise.resolve().then(() => require(`${__dirname}/routes/${fileOrFolderName}`));
            app.use(`/${routeName}`, module.default);
        }
        else {
            // subroutes from subfolders
            fs.readdirSync(`${__dirname}/routes/${fileOrFolderName}`).forEach((fileName) => __awaiter(void 0, void 0, void 0, function* () {
                const routeName = fileName.split('Route')[0];
                const module = yield Promise.resolve().then(() => require(`${__dirname}/routes/${fileOrFolderName}/${fileName}`));
    ...
    app.listen(port, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setInterval(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                ...
                const deleted = yield userRepo.deleteExpiredTempUsers();
