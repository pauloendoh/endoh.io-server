...
var createProfileForUsers = function () { return __awaiter(void 0, void 0, void 0, function () {
    var userRepo, profile, preferences, userIds, usersNoProfiles, _i, usersNoProfiles_1, user, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 10, , 11]);
                userRepo = typeorm_1.getCustomRepository(UserRepository_1.default);
                profile = typeorm_1.getRepository(Profile_1.Profile);
                return [4 /*yield*/, profile.find({ relations: ['user'] })];
            case 1:
                preferences = _a.sent();
                userIds = preferences.map(function (p) { return p.user.id; });
                usersNoProfiles = void 0;
                if (!userIds.length) return [3 /*break*/, 3];
                return [4 /*yield*/, userRepo
                        .find({ id: typeorm_1.Not(typeorm_1.In(__spreadArrays(userIds))) })];
            case 2:
                usersNoProfiles = _a.sent();
                return [3 /*break*/, 5];
            ...
            case 4:
                ...
                _a.label = 5;
            case 5:
                _i = 0, usersNoProfiles_1 = usersNoProfiles;
                _a.label = 6;
            case 6:
                if (!(_i < usersNoProfiles_1.length)) return [3 /*break*/, 9];
                user = usersNoProfiles_1[_i];
